...
\resumeSubItem{\textbf{Programming: }}{Javascript, Python, Bash, SQL, Java, \CC, C\mytextsharp }
\resumeSubItem{\textbf{Front-End: }}{React, Next.js, HTML/CSS, Tailwind CSS}
\resumeSubItem{\textbf{Back-End: }}{Node.js, Express.js, FastAPI}
...
{Bachelor of Computer Science (Honours) in Software Engineering}{Oct 2022 -- July 2026}
% \begin{spacing}{0.4}
...
\resumeSubheading{AutoPilot Asia Hackathon}{July 2026 - August 2026}
{Finalist}{APU Bukit Jalil}
\resumeItemListStart
\resumeItem{}{Built a full-stack AI command center that orchestrates an 11-agent
workflow.}
\resumeItem{}{Designed a dual-mode policy engine and human-in-the-loop exception
workflow.}
\resumeItem{}{Engineered a 17-detector insights engine}
\resumeItemListEnd

\resumeSubheading{Geco Asia - Break into AI: Hack to Hire Hackathon}{Nov 2025 - Dec 2025}
{2nd runner up}{TRX KL}
\resumeItemListStart
\resumeItem{}{Engineered a FastAPI and DynamoDB backend turning lagging survey data into real-time burnout and attrition insights.}
\resumeItem{}{Built an n8n and Gemini 2.0 sentiment pipeline with custom normalization for local Manglish slang.}
\resumeItem{}{Designed a risk engine surfacing actionable HR interventions across 16,000+ employees.}
\resumeItemListEnd

\resumeSubheading{MMU HACK DAY 2025}{Aug 2025}
{1st runner up}{Multimedia University}
\resumeItemListStart
\resumeItem{}{Built a CGPA tracker in TypeScript and React with real-time, semester-wise GPA monitoring.}
\resumeItem{}{Implemented weighted 40/60 formative-summative grading with automated academic standing classification.}
\resumeItem{}{Added What-If calculators for grade projection and risk assessment.}
\resumeItemListEnd
